...
def process_mimic_dataset():
    ...
    file_save_path = os.path.join(save_path,"MIMIC_inference_results.json")
    ...
    output_csv_path = '/ibex/project/c2106/MiniGPT4-v2/metric_results/bert_similarity_scores.csv'
...
def process_vqa_dataset():
    ...
    output_csv_path = '/ibex/project/c2106/MiniGPT4-v2/metric_results/vqa_bert_similarity_scores.csv'
