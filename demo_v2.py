...
title = """<h1 align="center">RadGPT Demo</h1>"""
description = 'Welcome to Our RadGPT Chatbot Demo!'
    ...
    with gr.Row():
        with gr.Column():
            gr.Examples(examples=[
                ["Med_examples_v2/1.3.6.1.4.1.14519.5.2.1.7009.9004.242286124999058976921785904029.png", "[identify] what is this {<81><56><90><68>}", upload_flag,
                ...
                ["Med_examples_v2/1.2.840.113654.2.55.48339325922382839066544590341580673064.png", "[refer] the nodule in the left lung", upload_flag, replace_flag,
                 img_list],
               ["Med_examples_v2/synpic676.jpg", "[grounding] describe this image in detail", upload_flag, replace_flag, img_list],
